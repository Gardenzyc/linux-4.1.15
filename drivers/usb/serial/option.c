 ...
 * Date is 2018/06/07;
 */
#define QUECTEL_VENOR_ID			0x2C7C
#define QUECTEL_EC20_PRODUCT_ID		0x0125
...
#define LYNQ_VENOR_ID			0x05c6
#define LYNQ_PRODUCT_L506		0x9025

#define LONGSUNG_VENOR_ID			0x1C9E
#define LONGSUNG_PRODUCT_C5300V		0x9e00	/* C5300v/C7500 */
#define LONGSUNG_PRODUCT_U6300V		0x9603	/* U6300/U7500 */
...
static const struct option_blacklist_info quectel_ec20_blacklist = {
	.reserved = BIT(4),
};

static const struct usb_device_id option_ids[] = {
	/* MYZR: tangb; EC20 */
	{ USB_DEVICE(QUECTEL_VENOR_ID, QUECTEL_EC20_PRODUCT_ID),
		.driver_info = (kernel_ulong_t)&quectel_ec20_blacklist },
	...
	{ USB_DEVICE(LYNQ_VENOR_ID, LYNQ_PRODUCT_L506) },
	{ USB_DEVICE(LONGSUNG_VENOR_ID, LONGSUNG_PRODUCT_C5300V) },
	{ USB_DEVICE(LONGSUNG_VENOR_ID, LONGSUNG_PRODUCT_U6300V) },
	{ USB_DEVICE(LONGSUNG_VENOR_ID, LONGSUNG_PRODUCT_U8300),
		.driver_info = (kernel_ulong_t)&longsung_u9300_blacklist },
	{ USB_DEVICE(LONGSUNG_VENOR_ID, LONGSUNG_PRODUCT_U9300),
		.driver_info = (kernel_ulong_t)&longsung_u9300_blacklist },
...
static struct usb_serial_driver option_1port_device = {
	...
	.reset_resume      = usb_wwan_resume,	/* MYZR: tangb; EC20 */
#endif
};
